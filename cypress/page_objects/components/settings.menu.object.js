...
export default class SettingsMenuObject extends ComponentObject {
    constructor() {
        ...
        this.addElements = {
            darkModeToggle: () =>
                cy.contains(".MuiFormControlLabel-root", "Enable dark mode").find("input"),
            ...
            temperatureUnitOption: (value) =>
                this.elements.temperatureUnitRadioGroup().find(`input[value="${value}"]`),
            ...
            windSpeedUnitOption: (value) =>
                this.elements.windSpeedUnitRadioGroup().find(`input[value="${value}"]`),
            ...
            precipitationUnitOption: (value) =>
                this.elements.precipitationUnitRadioGroup().find(`input[value="${value}"]`),
        };
    }
