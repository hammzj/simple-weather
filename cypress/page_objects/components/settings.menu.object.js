...
export default class SettingsMenuObject extends ElementCollection {
    ...
    get temperatureUnitRadioGroup() {
        return cy.contains('.MuiFormControl-root', 'Temperature unit').find('div[role="radiogroup"]');
    }
    ...
    get windSpeedUnitRadioGroup() {
        return cy.contains('.MuiFormControl-root', 'Wind speed unit').find('div[role="radiogroup"]');
    }
    ...
    get precipitationUnitRadioGroup() {
        return cy.contains('.MuiFormControl-root', 'Precipitation unit').find('div[role="radiogroup"]');
    }
    ...
    _assertRadioButtonIsSelected({
        ...
        if (temperatureUnitOption) this.temperatureUnitOption(temperatureUnitOption).should(matcher);
        if (windSpeedUnitOption) this.windSpeedUnitOption(windSpeedUnitOption).should(matcher);
        if (precipitationUnitOption) this.precipitationUnitOption(precipitationUnitOption).should(matcher);
    }
}
